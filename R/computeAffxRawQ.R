computeAffxRawQ <- function(intensity,stdvs,pixels,probe.index,probe.zoneID,
  bgCells,NumberZones) {
#######################################################################
#
...
# find the noise for each zone
	zonenoise <- tapply(probe.index,probe.zoneID,computeZonenoise,intensity,stdvs,pixels,bgCells)
