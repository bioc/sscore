...
analysis for the \Robject{Dilution} data set included with the \Rpackage{affy} package.  
...
cel <- Dilution[,c(1,2)] ## only need the first 2 columns
...
SDT=c(2526.300,2590.297),celfile.path=pathname)
@ 
